...
## which isn't really the most useful
...
```{r}
library(tidyverse)
moose_df_low <- read_csv(here("inst", "data/moose_low_2014_2018.csv"))
...
```{r}
library(tidyverse)
moose_df <- read_csv(here("inst", "data/moose_04_06.csv"))
...
## compare to sptotal
moose_2006 <- moose_df %>% dplyr::filter(Surveyyear == 2006)
