...
moose_temp_high <- read_csv(here("inst", "moose_high_2014_2018.csv"))
...
```{r}
library(tidyverse)
moose_df_low <- read_csv(here("inst", "moose_low_2014_2018.csv"))
...
```{r}
library(tidyverse)
moose_df <- read_csv(here("inst", "moose_04_06.csv"))
