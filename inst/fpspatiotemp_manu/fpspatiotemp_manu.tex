...
abundance, the total number of moose, in the region in order to inform
harvest regulations \citep{kellie2019challenges}. Because of time and
...
constructed with the \texttt{ggplot2 R} package
\citep{wickham2016data}.}
\end{figure}
...
two sites are 20 or more spatial units apart, no matter what the
temporal distance is. The covariance between two errors that are six
