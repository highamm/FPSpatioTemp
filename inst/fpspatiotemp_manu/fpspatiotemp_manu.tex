...
\author{\name{Matt Higham$^{a}$, John Smith$^{b}$, Dominik Leutnant$^{c,
\dagger, \ddagger}$}
\affil{$^{a}$St.~Lawrence University Canton, NY 13617; $^{b}$Institut
für Informatik, Albert-Ludwigs-Universität, Freiburg,
