...
figure graphics are constructed with the \textbackslash texttt\{ggplot2
R\} package \citep{wickham2016data}.The number of units sampled
throughout all survey years, \(n\), is 487 units.
