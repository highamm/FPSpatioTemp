...
```{r covplot, fig.cap = "\\label{fig:covplot} Estimated covariance of the errors from the estimated parameters in a spatio-temporal product-sum model. The centroids of two sites directly adjacent to one another are about 4 spatial kilometers apart."}
